...
keys = [Key(key[0], key[1], *key[2:]) for key in [
    ...
    #Apps
    ([mod], "i", lazy.spawn("intellij-idea-ultimate-edition")),
    ([mod], "v", lazy.spawn("vscodium")),
    ...
    # Redshift
    ([mod], "r", lazy.spawn("redshift -O 2700")),
    ...
    # Brightness
    ([], "XF86MonBrightnessUp", lazy.spawn("sudo brillo -A 10")),
    ([], "XF86MonBrightnessDown", lazy.spawn("sudo brillo -U 10")),
]]
